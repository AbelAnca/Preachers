...
@IBDesignable class ADVSegmentedControl: UIControl {
    ...
    var items: [String] = ["Sermons", "Details", "Place"] {
        didSet {
            setupLabels()
        }
    }
    ...
    @IBInspectable var selectedLabelColor : UIColor = k_UIColor_Button_Orange {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var unselectedLabelColor : UIColor = k_UIColor_Button_Gray {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var thumbColor : UIColor = k_UIColor_Button_Orange {
        didSet {
            setSelectedColors()
        }
    }
    ...
    func setupLabels(){
        ...
        for index in 1...items.count {
            ...
            label.font = UIFont(name: k_UIFont_ProximaNova_Regular, size: 14)
    ...
    override func layoutSubviews() {
        ...
        thumbView.frame = CGRectMake(0, selectFrame.size.height - 3, selectFrame.size.width, 3)
    ...
    func displayNewSelectedIndex(){
        ...
        UIView.animateWithDuration(0.5, delay: 0.0, usingSpringWithDamping: 0.5, initialSpringVelocity: 0.8, options: [], animations: {
            ...
            self.thumbView.frame    = CGRectMake(
                label.frame.origin.x,
                self.thumbView.frame.origin.y,
                self.thumbView.frame.size.width,
